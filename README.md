...
free to poke around with it to see what it can do. However what it can offer (with a lot of amateurity) is a strictly in memory backdoor framework that has a somewhat high 
